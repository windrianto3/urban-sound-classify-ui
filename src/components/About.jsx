  ...
  return (
    <div className='h-screen w-full bg-white'>
        <div className='max-w-[80%] md:max-w-[60%] mx-auto flex flex-col px-8 py-24 h-full justify-start'>
            ...
            <p className='text-xl py-2'> Uploaded files are sent to a <b>Flask API</b> hosted on the <b>Google Cloud Platform</b> that processes the sound file using <b>Librosa</b> to extract features, which are then passed through the model to predict the class.</p>
